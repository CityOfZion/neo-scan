...
config :neoscan,
  governing_token:
    Base.decode16!("c56f33fc6ecfcd0c225c4ab356fee59390af8560be0e930faebe74a6daff7c9b",
      case: :mixed
    )

config :neoscan,
  utility_token:
    Base.decode16!("602c79718b16e442de58778e148d0b1084e3b2dffd5de6b7b16cee7969282de7",
      case: :mixed
    )
