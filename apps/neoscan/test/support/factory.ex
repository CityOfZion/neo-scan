defmodule Neoscan.Factory do
  ...
  def block_factory do
    %Block{
      ...
      index: sequence(1, & &1),
      merkleroot: :crypto.strong_rand_bytes(32),
      previousblockhash: :crypto.strong_rand_bytes(32),
      nextblockhash: :crypto.strong_rand_bytes(32),
      nextconsensus: :crypto.strong_rand_bytes(32),
