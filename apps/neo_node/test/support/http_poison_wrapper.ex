defmodule NeoNode.HTTPPoisonWrapper do
  ...
  @transactionfd %{
    "attributes" => [],
    "blockhash" => "0xd7eaf396549415320c023523282e0c2160176a0519810e19a01eb13f4be55c63",
    "blocktime" => 1_499_134_416,
    "confirmations" => 1_359_296,
    "contract" => %{
      "author" => "Erik Zhang",
      "code" => %{
    ...
    "scripts" => [
      %{
        "invocation" =>
          "404b6c8254acd0925ccef7620488de7abb14aa4c42bfe245fa7e916c08922ea62a6251d2df433cb0e753eb71db626d1a8770825372d9ddb99818aa3a8c84ef2797",
        "verification" => "2103c368b6aac37dda8a401fd04ec4d868f6c67ff3802e5e047918ae6c84d4fc3a50ac"
      }
    ],
    "size" => 972,
    "sys_fee" => "500",
    "txid" => "0xfd161ccd87deab812daa433cbc0f8f6468de24f1d708187beef5ab9ada7050f3",
    "type" => "PublishTransaction",
    "version" => 0,
    "vin" => [
      %{
        "txid" => "0xa899f409d3a753192a3eb6cd7fdaef4c3b69d23e12b65e3b32abc18588403122",
        "vout" => 0
      }
    ],
    "vout" => [
      %{
        "address" => "ANxAmsn9Qnx5gEUtgsmSqt7TycE7Vbkdv4",
        "asset" => "0x602c79718b16e442de58778e148d0b1084e3b2dffd5de6b7b16cee7969282de7",
        "n" => 0,
        "value" => "0.00023856"
      }
  ...
  @transaction45 %{
    "attributes" => [
      %{
        "data" => "5fa99d93303775fe50ca119c327759313eccfa1c",
        "usage" => "Script"
      }
    ],
    "blockhash" => "0x1f9e6de446b3b78807efd0df1b22be35a661b608def2ccfc0cc7909ceacfec4e",
    "blocktime" => 1_503_219_640,
    "confirmations" => 1_193_922,
    "gas" => "1",
    "net_fee" => "0",
    "script" =>
    ...
    "scripts" => [
      %{
        "invocation" =>
          "",
        "verification" =>
    ...
    "size" => 981,
    "sys_fee" => "1",
    "txid" => "0x45ced268026de0fcaf7035e4960e860b98fe1ae5122e716d9daac1163f13e534",
    "type" => "InvocationTransaction",
    "version" => 1,
    "vin" => [
      %{
        "txid" => "0x0f1f3e1b3becc0ad835ba7f19a0290743ebc1773705f2c44f63cf6a89dd4c6aa",
        "vout" => 0
      }
    ],
    "vout" => []
