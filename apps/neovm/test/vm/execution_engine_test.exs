defmodule NeoVM.ExecutionEngineTest do
  ...
  test "HASH256" do
    assert %{
             stack: [
               <<20, 6, 224, 88, 129, 226, 153, 54, 119, 102, 211, 19, 226, 108, 5, 86, 78, 201,
                 27, 247, 33, 211, 23, 38, 189, 110, 70, 230, 6, 137, 83, 154>>
             ]
  ...
  test "RIMEMD160" do
    assert %{
             stack: [
               <<200, 27, 148, 147, 52, 32, 34, 26, 122, 192, 4, 169, 2, 66, 216, 177, 211, 229,
                 7, 13>>
             ]
  ...
  test "HASH160" do
    assert %{
             stack: [
               <<159, 127, 208, 150, 211, 126, 210, 192, 227, 247, 240, 207, 201, 36, 190, 239,
                 79, 252, 235, 104>>
             ]
